...
namespace GeoJSON.Text.Tests.Geometry
{
    ...
    //        {
    //            new MyPoint(new Text.Geometry.Position(52.370725881211314, 4.889259338378906)),
    //            new MyPoint(new Text.Geometry.Position(52.3711451105601, 4.895267486572266)),
    //            new MyPoint(new Text.Geometry.Position(52.36931095278263, 4.892091751098633)),
    //            new MyPoint(new Text.Geometry.Position(52.370725881211314, 4.889259338378906))
    //        };
    ...
    //    //    var points = new List<MyPoint>
    //    //    {
    //    //        new MyPoint(new Text.Geometry.Position(39.57422, -105.01621)),
    //    //        new MyPoint(new Text.Geometry.Position(35.0539943, -80.6665134)),
    //    //    };

...
namespace GeoJSON.Text.Feature
{
    ...
    /// See https://tools.ietf.org/html/rfc7946#section-3.2
    /// </remarks>
//    public class Feature<Point, TProps> : GeoJSONObject//, IEquatable<Feature<Point, TProps>>
//        //where TGeometry : IGeometryObject
//    {
//        private string _id;
//        private bool _idHasValue = false;
...
//        public Feature(Point geometry, TProps properties, string id = null)
//        {
//            Geometry = geometry;
//            Properties = properties;
//            Id = id;
...
//        /// <param name="other"></param>
//        /// <returns></returns>
//        public bool Equals(Feature<Point, TProps> other)
//        {
//            if (other is null) return false;
//            if (ReferenceEquals(this, other)) return true;
//            return base.Equals(other)
//                   && string.Equals(Id, other.Id)
//                   && EqualityComparer<Point>.Default.Equals(Geometry, other.Geometry)
//                   && EqualityComparer<TProps>.Default.Equals(Properties, other.Properties);
//        }
...
//            if (ReferenceEquals(this, obj)) return true;
//            if (obj.GetType() != GetType()) return false;
//            return Equals((Feature<Point, TProps>)obj);
//        }
...
//                var hashCode = base.GetHashCode();
//                hashCode = (hashCode * 397) ^ (Id != null ? Id.GetHashCode() : 0);
//                hashCode = (hashCode * 397) ^ EqualityComparer<Point>.Default.GetHashCode(Geometry);
//                hashCode = (hashCode * 397) ^ EqualityComparer<TProps>.Default.GetHashCode(Properties);
//                return hashCode;
//            }
//        }
...
//        public Feature(Point geometry, IDictionary<string, object> properties = null, string id = null)
//            : base(geometry, properties, id)
//        {
//        }
...
//    /// <remarks>Returns correctly typed Geometry property</remarks>
//    /// <typeparam name="TGeometry"></typeparam>
//    public class Feature<Point> : Feature<Point, IDictionary<string, object>>, IEquatable<Feature<Point>> //where TGeometry : IGeometryObject
//    {
//        public Feature()
//        {
...
//        /// </param>
//        /// <param name="id">The (optional) identifier.</param>
//        public Feature(Point geometry, object properties, string id = null)
//        : this(geometry, GetDictionaryOfPublicProperties(properties), id)
//        {
//        }
...
//        public bool Equals(Feature<Point> other)
//        {
//            if (other is null) return false;
//            if (ReferenceEquals(this, other)) return true;
...
//            return EqualityComparer<Point>.Default.Equals(Geometry, other.Geometry);
//        }
...
//            if (obj is null) return false;
//            if (ReferenceEquals(this, obj)) return true;
//            return obj.GetType() == GetType() && Equals((Feature<Point>)obj);
//        }
